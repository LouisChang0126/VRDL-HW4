...
def apply_tta(model, input_):
    ...
    90°/180°/270° rotations, diagonal flip.
    """
    ...
    output_anti_diag = torch.flip(output_anti_diag, dims=[2])
    # Reverse horizontal flip
    output_anti_diag = torch.flip(output_anti_diag, dims=[3])
    # Reverse transpose
    output_anti_diag = torch.transpose(output_anti_diag, 2, 3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str, default="test/degraded/",
                        help='save path of test images')
    parser.add_argument('--output_path', type=str,
                        default="output/demo/", help='output save path')
    parser.add_argument('--ckpt_name', type=str,
                        default="train_ckpt/val-psnr.ckpt",
    ...
    testloader = DataLoader(
        test_set, batch_size=1, pin_memory=True, shuffle=False, num_workers=0)
